            ...
            <div class="card" style="width: 40rem;">
                ...
                <div class="card-body">
                    ...
                    if (isset($_POST['form6'])) {
                        ...
                        $SumaA = $FrecuenciaFiabilidadA + $FrecuenciaLinksA + $FrecuenciaCapacidadA + $FrecuenciaCostoA;
                        $SumaB = $FrecuenciaFiabilidadB + $FrecuenciaLinksB + $FrecuenciaCapacidadB + $FrecuenciaCostoB;
