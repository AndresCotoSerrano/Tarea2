    ...
    <div class="row">
        <div class="col-sm">
            ...
            if (isset($_POST['form1'])) {
                ...
                $SumaAsimilador=$CaAsimilador+$EcAsimilador+$EcAsimilador+$OrAsimilador;
                $SumaAcomodador=$CaAcomodador+$EcAcomodador+$EcAcomodador+$OrAcomodador;
                $SumaConvergente=$CaConvergente+$EcConvergente+$EcConvergente+$OrConvergente;
                $SumaDivergente=$CaDivergente+$EcDivergente+$EcDivergente+$OrDivergente;
